...
(72, 'Silver Detailed Ring', 19, 'men-ring', 'images/mens/rings/mens-slver-detailed-ring.jpg', 'This might be another silver ring, however, it is different as it has beautiful detailing around the ring. The background of this detail is dark grey as well, making it stand out. So why not go for a silver ring but an upgraded version of it?', 'Silver Detailed Ring', '2022-11-30', '2022-12-01', 10, 0),
